      ...
      <nav className="flex flex-1 flex-col justify-between gap-2">
        ...
        <div className="mt-auto border-t border-slate-200 pt-3">
          <button
            type="button"
            onClick={onLogout}
            className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm text-slate-600 transition hover:bg-red-50 hover:text-red-700 hover:ring-1 hover:ring-red-200"
          >
            <LogOut size={18} />
            <span>Logout</span>
          </button>
